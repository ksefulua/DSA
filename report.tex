...
\newcommand{\tikzstyles}{
\tikzset {
BlockStyle/.style = {shape=rectangle, draw=black, text=black, minimum height=1cm}
}
}

\newtcblisting{commandshell}{colback=black,colupper=white,colframe=red!75!black,
listing only,listing options={language=sh},
every listing line={\textcolor{red}{\small\ttfamily\bfseries Blockchain \$> }}}
...
\begin{document}
    ...
    \begin{titlepage}
        \begin{center}
            \includegraphics[scale=0.15]{img/logoulb.jpg}
        \end{center}
        \center
        \vspace{2cm}
        ...
        \textsc{\Large Project report : Algorithms in Secondary Memory} %\\[1.5cm]
