...
class runThreads extends Thread {
    ...
    public runThreads(String name){
      ...
      public void run(){
        ...
        IntBuffer buffer =  IntBuffer.allocate(1); // initialisation du buffer pour la methode 3 avec capacité 1
        
        for (int i=0; i<N; i++){
            //methode 1 : 
            /* Si tu veux tester l'ecriture N fois d'un element et la lecture 
            pour la methode 1 tu dois enlever du commentaire la ligne 22 et la ligne 35
            et si tu execute ça affichera le temps en nanoseconds que ça a pris
            pareil pour la methode 2 (sort du commentaire les lignes 24 et 37)*/
